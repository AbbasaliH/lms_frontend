...
const mockData = [
  ...
  { month: 'Aug', revenue: 68000, orders: 188 },
  { month: 'Sep', revenue: 75000, orders: 205 },
  { month: 'Oct', revenue: 82000, orders: 225 },
  { month: 'Nov', revenue: 88000, orders: 242 },
  { month: 'Dec', revenue: 95000, orders: 268 },
];
  ...
  return (
    <Card className="animate-in fade-in-50 slide-in-from-bottom-4 duration-700">
      <CardHeader>
        ...
        <CardDescription>Monthly revenue and order trends for the past year</CardDescription>
      </CardHeader>
